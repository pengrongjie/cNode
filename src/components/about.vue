<template>
    <div class="aboutContent">
      ...
      <div class="second">
        <h3>源码地址</h3>
        <p><a href="https://github.com/pengrongjie/cNode" target="_blank">https://github.com/LeeWgg/CNode</a></p>
      </div>
      <div class="third">
        <h3>意见反馈</h3>
        <p><a href="https://github.com/pengrongjie/cNode/issues" target="_blank">发表意见或者提需求</a></p>
      </div>
      <div class="fourthly">
        <h3>当前版本</h3>
        <p>vue2.0</p>
